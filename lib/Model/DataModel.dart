/// updated : 1692785439986
/// cases : 694057658
/// todayCases : 0
/// deaths : 6909702
/// todayDeaths : 0
/// recovered : 665868836
/// todayRecovered : 54112
/// active : 21279120
/// critical : 37461
/// casesPerOneMillion : 89041
/// deathsPerOneMillion : 886.5
/// tests : 6999856381
/// testsPerOneMillion : 881046.39
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2678.33
/// recoveredPerOneMillion : 83810.48
...
DataModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => DataModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
